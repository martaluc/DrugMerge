...
python drugranking.py  --mode=filteronly --fdadrugsonly=False  $GEO4 $GEO6 $GEO1 $GEO0 $GEO3  $allfilters  >   ./modulation-covid19-pbmc-results-pval-nofda-allposonly/global-filter-covid19-all-2021-03-25-laptop-01.txt  
python drugranking.py  --mode=filteronly --fdadrugsonly=False  $GEO4 $GEO6 $GEO1 $GEO0  $allfilters  >   ./modulation-covid19-pbmc-results-pval-nofda-allposonly/global-filter-covid19-all-2021-03-25-laptop-02.txt  
python drugranking.py  --mode=filteronly --fdadrugsonly=False  $GEO4 $GEO6 $GEO1  $allfilters   >  ./modulation-covid19-pbmc-results-pval-nofda-allposonly/global-filter-covid19-all-2021-03-25-laptop-03.txt  
python drugranking.py  --mode=filteronly --fdadrugsonly=False  $GEO4 $GEO6  $allfilters   >  ./modulation-covid19-pbmc-results-pval-nofda-allposonly/global-filter-covid19-all-2021-03-25-laptop-04.txt  

echo DM data filter
python drugranking.py  --mode=filteronly --fdadrugsonly=False -conf=\(pbmc,DM,4\) -conf=\(balf,DM,4\) -conf=\(cells,DM,4\) -conf=\(pbmc,DM,1\) -conf=\(balf,DM,1\) -conf=\(cells,DM,1\)  $allfilters  >  ./modulation-covid19-pbmc-results-pval-nofda-allposonly/global-filter-covid19-all-2021-03-25-laptop-12.txt  
...
python drugranking.py  --mode=filteronly --fdadrugsonly=False $CMAP6 $CMAP1 $CMAP3 $CMAP0 $CMAP5 $CMAP4 $CMAP2   $allfilters  >   ./modulation-covid19-pbmc-results-pval-nofda-allposonly/global-filter-covid19-all-2021-03-25-laptop-41.txt  
python drugranking.py  --mode=filteronly --fdadrugsonly=False $CMAP6 $CMAP1 $CMAP3 $CMAP0 $CMAP5 $CMAP4  $allfilters  >   ./modulation-covid19-pbmc-results-pval-nofda-allposonly/global-filter-covid19-all-2021-03-25-laptop-42.txt  
python drugranking.py  --mode=filteronly --fdadrugsonly=False $CMAP6 $CMAP1 $CMAP3 $CMAP0 $CMAP5  $allfilters   >  ./modulation-covid19-pbmc-results-pval-nofda-allposonly/global-filter-covid19-all-2021-03-25-laptop-43.txt  
python drugranking.py  --mode=filteronly --fdadrugsonly=False $CMAP6 $CMAP1 $CMAP3 $CMAP0  $allfilters   >  ./modulation-covid19-pbmc-results-pval-nofda-allposonly/global-filter-covid19-all-2021-03-25-laptop-44.txt  
python drugranking.py  --mode=filteronly --fdadrugsonly=False $CMAP6 $CMAP1 $CMAP3  $allfilters   >  ./modulation-covid19-pbmc-results-pval-nofda-allposonly/global-filter-covid19-all-2021-03-25-laptop-45.txt  
python drugranking.py  --mode=filteronly --fdadrugsonly=False $CMAP6 $CMAP1  $allfilters   >  ./modulation-covid19-pbmc-results-pval-nofda-allposonly/global-filter-covid19-all-2021-03-25-laptop-46.txt  
...
python drugranking.py  --mode=filteronly --fdadrugsonly=False $L10000 $L10004 $L10002 $L10001 $L10003 $L10005 $L10006   $allfilters  >  ./modulation-covid19-pbmc-results-pval-nofda-allposonly/global-filter-covid19-all-2021-03-25-laptop-51.txt  
python drugranking.py  --mode=filteronly --fdadrugsonly=False $L10000 $L10004 $L10002 $L10001 $L10003 $L10005  $allfilters  >  ./modulation-covid19-pbmc-results-pval-nofda-allposonly/global-filter-covid19-all-2021-03-25-laptop-52.txt  
python drugranking.py  --mode=filteronly --fdadrugsonly=False $L10000 $L10004 $L10002 $L10001 $L10003  $allfilters  >  ./modulation-covid19-pbmc-results-pval-nofda-allposonly/global-filter-covid19-all-2021-03-25-laptop-53.txt  
python drugranking.py  --mode=filteronly --fdadrugsonly=False $L10000 $L10004 $L10002 $L10001  $allfilters  >  ./modulation-covid19-pbmc-results-pval-nofda-allposonly/global-filter-covid19-all-2021-03-25-laptop-54.txt  
python drugranking.py  --mode=filteronly --fdadrugsonly=False $L10000 $L10004 $L10002  $allfilters  >  ./modulation-covid19-pbmc-results-pval-nofda-allposonly/global-filter-covid19-all-2021-03-25-laptop-55.txt  
python drugranking.py  --mode=filteronly --fdadrugsonly=False $L10000 $L10004   $allfilters  >  ./modulation-covid19-pbmc-results-pval-nofda-allposonly/global-filter-covid19-all-2021-03-25-laptop-56.txt  
