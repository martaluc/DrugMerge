...
drugranking.py  --mode=filteronly --fdadrugsonly=True  %GEO4% %GEO6% %GEO1% %GEO0% %GEO3%  %allfilters%  >   ./modulation-covid19-pbmc-results-pval-fdaonly-allposonly/global-filter-covid19-all-2021-03-25-laptop-01.txt
drugranking.py  --mode=filteronly --fdadrugsonly=True  %GEO4% %GEO6% %GEO1% %GEO0%  %allfilters%  >   ./modulation-covid19-pbmc-results-pval-fdaonly-allposonly/global-filter-covid19-all-2021-03-25-laptop-02.txt
drugranking.py  --mode=filteronly --fdadrugsonly=True  %GEO4% %GEO6% %GEO1%  %allfilters%   >  ./modulation-covid19-pbmc-results-pval-fdaonly-allposonly/global-filter-covid19-all-2021-03-25-laptop-03.txt
drugranking.py  --mode=filteronly --fdadrugsonly=True  %GEO4% %GEO6%  %allfilters%   >  ./modulation-covid19-pbmc-results-pval-fdaonly-allposonly/global-filter-covid19-all-2021-03-25-laptop-04.txt

ECHO DM data filter
drugranking.py  --mode=filteronly --fdadrugsonly=True -conf=(pbmc,DM,4) -conf=(balf,DM,4) -conf=(cells,DM,4) -conf=(pbmc,DM,1) -conf=(balf,DM,1) -conf=(cells,DM,1)  %allfilters%  >  ./modulation-covid19-pbmc-results-pval-fdaonly-allposonly/global-filter-covid19-all-2021-03-25-laptop-12.txt
...
drugranking.py  --mode=filteronly --fdadrugsonly=True %CMAP6% %CMAP1% %CMAP3% %CMAP0% %CMAP5% %CMAP4% %CMAP2%   %allfilters%  >   ./modulation-covid19-pbmc-results-pval-fdaonly-allposonly/global-filter-covid19-all-2021-03-25-laptop-41.txt
drugranking.py  --mode=filteronly --fdadrugsonly=True %CMAP6% %CMAP1% %CMAP3% %CMAP0% %CMAP5% %CMAP4%  %allfilters%  >   ./modulation-covid19-pbmc-results-pval-fdaonly-allposonly/global-filter-covid19-all-2021-03-25-laptop-42.txt
drugranking.py  --mode=filteronly --fdadrugsonly=True %CMAP6% %CMAP1% %CMAP3% %CMAP0% %CMAP5%  %allfilters%   >  ./modulation-covid19-pbmc-results-pval-fdaonly-allposonly/global-filter-covid19-all-2021-03-25-laptop-43.txt
drugranking.py  --mode=filteronly --fdadrugsonly=True %CMAP6% %CMAP1% %CMAP3% %CMAP0%  %allfilters%   >  ./modulation-covid19-pbmc-results-pval-fdaonly-allposonly/global-filter-covid19-all-2021-03-25-laptop-44.txt
drugranking.py  --mode=filteronly --fdadrugsonly=True %CMAP6% %CMAP1% %CMAP3%  %allfilters%   >  ./modulation-covid19-pbmc-results-pval-fdaonly-allposonly/global-filter-covid19-all-2021-03-25-laptop-45.txt
drugranking.py  --mode=filteronly --fdadrugsonly=True %CMAP6% %CMAP1%  %allfilters%   >  ./modulation-covid19-pbmc-results-pval-fdaonly-allposonly/global-filter-covid19-all-2021-03-25-laptop-46.txt
...
drugranking.py  --mode=filteronly --fdadrugsonly=True %L10000% %L10004% %L10002%  %allfilters%  >  ./modulation-covid19-pbmc-results-pval-fdaonly-allposonly/global-filter-covid19-all-2021-03-25-laptop-51.txt
drugranking.py  --mode=filteronly --fdadrugsonly=True %L10000% %L10004%    %allfilters%  >  ./modulation-covid19-pbmc-results-pval-fdaonly-allposonly/global-filter-covid19-all-2021-03-25-laptop-52.txt
drugranking.py  --mode=filteronly --fdadrugsonly=True %L10000%  %L10002% %allfilters% >  ./modulation-covid19-pbmc-results-pval-fdaonly-allposonly/global-filter-covid19-all-2021-03-25-laptop-53.txt
drugranking.py  --mode=filteronly --fdadrugsonly=True %L10004% %L10002%  %allfilters%  >  ./modulation-covid19-pbmc-results-pval-fdaonly-allposonly/global-filter-covid19-all-2021-03-25-laptop-54.txt
::drugranking.py  --mode=filteronly --fdadrugsonly=True %L10000% %L10004% %L10002%  %allfilters%  >  ./modulation-covid19-pbmc-results-pval-fdaonly-allposonly/global-filter-covid19-all-2021-03-25-laptop-55.txt
::drugranking.py  --mode=filteronly --fdadrugsonly=True %L10000% %L10004%   %allfilters%  >  ./modulation-covid19-pbmc-results-pval-fdaonly-allposonly/global-filter-covid19-all-2021-03-25-laptop-56.txt
